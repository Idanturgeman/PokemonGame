...
public class NodeTest {
    ...
    void get_E(){
        ...
        g.connect(3,1,1);
        g.connect(1,3,1);
        Collection<edge_data> E = n1.getEdgeCol();
    ...
    void remove_edge(){
        ...
        g.connect(2,1,1);
        g.connect(3,1,1);
        Collection<edge_data> E = n2.getEdgeCol();
        Assertions.assertEquals(2,E.size());
    ...
    void remove_back(){
        ...
        g.connect(1,2,1);
        g.connect(3,2,1);
        Collection<edge_data> BE = n2.getEdgeCol2();
        Assertions.assertEquals(2,BE.size());
        n2.removeReversEdge(10);
        n2.removeReversEdge(2);
        n2.removeReversEdge(1);
        n2.removeReversEdge(1);
